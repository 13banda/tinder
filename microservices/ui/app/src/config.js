...
export let config = {
    url:{
          ...
          data:"https://data.gamey34.hasura-app.io/v1/query",
          logout:"https://auth.gamey34.hasura-app.io/v1/user/logout",
          delete_user:"https://api.gamey34.hasura-app.io/delete",
          insert_user:"https://api.gamey34.hasura-app.io/insert-user",
          update_user:"https://api.gamey34.hasura-app.io/update-user",
          like_users:"https://api.gamey34.hasura-app.io/like-users",
          like:"https://api.gamey34.hasura-app.io/like",
          nope:"https://api.gamey34.hasura-app.io/nope",
          user_info:"https://auth.gamey34.hasura-app.io/v1/user/info",
          login: "https://auth.gamey34.hasura-app.io/v1/login",
          signup:"https://auth.gamey34.hasura-app.io/v1/signup",
